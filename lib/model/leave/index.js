...
const approvalResolver = new ApprovalResolver(Models);
...
function createNewLeave(args) {
  ...
  return Promise
    ...
    .then(leave => approvalResolver.resolveApprovers(leave).then(() => leave))
    .then(leave => approvalResolver.resolveWatchers(leave).then(() => leave))
